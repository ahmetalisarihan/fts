...
export default async function Product(
    ...
    return (
        ...
        <p>{description}</p> */}
            <div>
                <Link href="/" className='p-2 border border-indigo-300 rounded-xl hover:shadow-xl hover:shadow-indigo-50 flex flex-col'>
                    <Image src={image} className='shadow rounded-lg overflow-hidden border' alt="" width={250} height={250} />
                    <div className=' '>
